...
export const LongShortBar = ({symbol, long, short}: any) => {
    ...
    return (
        <div style={{display: "flex", width: "100%", height: "50px", padding: 4}}>
            ...
            <div style={{display: "flex", alignItems: "center", justifyContent: "flex-end",  flex: longRatio, backgroundColor: "green", borderTopLeftRadius:"10px", borderBottomLeftRadius:"10px"}}>
                <Text style={{fontSize: "12px", color: "white", paddingRight: "16px", margin: 0}}>LONG</Text>
                <Title level={4} style={{color: "white", paddingRight: "8px", margin: 0}}>{longRatio}%</Title>
            </div>
            <div style={{display: "flex", alignItems: "center", justifyContent: "flex-start",  flex: shortRatio, backgroundColor: "red", borderTopRightRadius:"10px", borderBottomRightRadius:"10px"}}>
                <Title level={4} style={{color: "white", paddingLeft: "8px", margin: 0}}>{shortRatio}%</Title>
